...
edges.ar <- edges.ar[edges.ar$ref!='Versteegh (2001)',] # remove for aesthetic reasons
...
edges.ar.net %v% 'vertex.labsize' <- ifelse(grepl('\\(',network.vertex.names(edges.ar.net)),1,3)
